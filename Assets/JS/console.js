...
const lectures = ['Основы языка HTML', 'Углубленное изучение HTML', 'Основы работы с CSS', 'Адаптивная вёрска с Flexbox и Grid Layout']
const practices = ['Основы языка HTML', 'Формы и кнопки в HTML', 'Таблицы и интерактивные элементы HTML']
/** добавляем ещё одно значеие в конец */
lectures.push('Bootstrap - работа с фреймворком');
/** добавляем ещё одно значеие в начало */
practices.unshift('Введиние в GitHub и GitHub Pages')
...
/* поиск предметов на О*/ 
function array_o(a) {
    return a.filter(element => element.startsWith('О'));
}
